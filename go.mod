...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi v1.25.11
	github.com/crossplane/crossplane-runtime v1.18.0 // current version of function-sdk-go does not support 1.16
